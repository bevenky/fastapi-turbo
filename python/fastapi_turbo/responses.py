...
class Response:
    ...
    def set_cookie(
        ...
        if samesite is not None:
            ...
            # identically under stock FastAPI and fastapi-turbo.
...
class JSONResponse(Response):
    ...
    fastapi-turbo's default response path bypasses this class entirely and
...
class EventSourceResponse(StreamingResponse):
    ...
    def _encode_stream(content):
        ...
        def _ping_interval() -> float:
            ...
            try:
                ...
                pass
            try:
                from fastapi_turbo.sse import _PING_INTERVAL as _pi
                return float(_pi)
            except Exception:  # noqa: BLE001
                return 15.0
    ...
    def _encode_item(item) -> bytes:
        ...
        try:
            from fastapi_turbo.sse import ServerSentEvent, format_sse_event
        except ImportError:
...
class ORJSONResponse(Response):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from fastapi_turbo.exceptions import FastAPIDeprecationWarning as _W
        _warnings.warn(
