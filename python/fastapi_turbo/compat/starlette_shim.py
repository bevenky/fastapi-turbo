...
def _build() -> dict[str, types.ModuleType]:
    ...
    import fastapi_turbo.middleware.gzip as _gzip
    import fastapi_turbo.middleware.trustedhost as _trustedhost
    import fastapi_turbo.middleware.httpsredirect as _httpsredirect
    ...
    starlette_ds.UploadFile = fastapi_turbo.UploadFile  # type: ignore[attr-defined]
    ...
    import fastapi_turbo.middleware.base as _base
    ...
    import fastapi_turbo.middleware.sessions as _sessions
    ...
    import fastapi_turbo.authentication as _auth
    ...
    from fastapi_turbo.testclient import TestClient, _WebSocketTestSession
