...
# Async-handler driving glue relocated to _door_support.py (kept after the
# clone dies); imported here for build_resolution_plan's own dep wrapping.
from fastapi_turbo._door_support import _make_sync_wrapper  # noqa: E402
