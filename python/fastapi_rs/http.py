...
Usage:
    from fastapi_rs.http import Client, Response, BasicAuth, Timeout
    ...
    # gather() — parallel requests in Rust (unique to fastapi-rs):
...
from fastapi_rs._fastapi_rs_core import RawResponse, RustTransport
